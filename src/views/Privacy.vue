<template>
  <div class="privacy">
    ...
    <div id="text">
      <div><h1>1. Informacje ogólne</h1></div>
      <div>
        <ol>
          <li>Niniejsza polityka dotyczy Serwisu www, funkcjonującego pod adresem url: <b>makoto.pl</b></li>
          <li>Operatorem serwisu oraz Administratorem danych osobowych jest: Patryk Dąbrowski Ludzisko, 88-160, Janikowo</li>
          <li>Adres kontaktowy poczty elektronicznej operatora: makoto.kontakt@gmail.com</li>
      ...
      <div><h1>2. Wybrane metody ochrony danych stosowane przez Operatora</h1></div>
      <div>
        <ol>
      ...
      <div><h1>3. Hosting</h1></div>
      <div>
        <ol>
          <li>Serwis jest hostowany (technicznie utrzymywany) na serwera operatora: vercel.com</li>
        </ol>
      </div>
      <div><h1>4. Twoje prawa i dodatkowe informacje o sposobie wykorzystania danych</h1></div>
      <div>
        <ol>
      ...
      <div><h1>5. Informacje w formularzach</h1></div>
      <div>
        <ol>
      ...
      <div><h1>6. Logi Administratora</h1></div>
      <div>
        <ol>
      ...
      <div><h1>7. Istotne techniki marketingowe</h1></div>
      <div>
        <ol>
      ...
      <div><h1>8. Informacja o plikach cookies</h1></div>
      <div>
        <ol>
      ...
      <div><h1>9. Zarządzanie plikami cookies – jak w praktyce wyrażać i cofać zgodę?</h1></div>
      <div>
        <ol>
